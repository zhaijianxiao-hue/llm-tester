...
class OpenAIProvider(BaseProvider):
    ...
    async def test_context(
        ...
        try:
            ...
            # Each message should be unique so we can test memory
            for i in range(min(context_size // 100, 10)):  # Limit to 10 messages
                messages.append(
                    {
                        "role": "user",
            ...
            if response.status_code == 200:
                ...
                # Simple memory check: did it answer about 42?
